...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Bulan Mei 2025 pada 13.52
...
(62, 1, 'DELETE', 'User telah dihapus: Ari', '2025-05-14 02:55:15'),
(63, 2, 'DELETE', 'User telah dihapus: Ari eka', '2025-05-14 02:55:15'),
(64, 3, 'DELETE', 'User telah dihapus: M.Daniel Khaikal', '2025-05-14 02:55:15'),
(65, 4, 'DELETE', 'User telah dihapus: M.Jubaesilah', '2025-05-14 02:55:15'),
(66, 1, 'INSERT', 'User baru telah ditambahkan: Ari Eka Prianda', '2025-05-14 03:10:55'),
(67, 1, 'UPDATE', 'Data user telah diperbarui: Ari Eka Prianda', '2025-05-14 03:12:21'),
(68, 1, 'UPDATE', 'Data user telah diperbarui: Ari Eka Prianda', '2025-05-14 03:13:56'),
(69, 1, 'UPDATE', 'Data user telah diperbarui: Ari Eka Prianda', '2025-05-14 03:29:44'),
(70, 1, 'UPDATE', 'Data user telah diperbarui: Ari Eka Prianda', '2025-05-14 03:30:18'),
(71, 2, 'INSERT', 'User baru telah ditambahkan: Ari', '2025-05-14 03:32:31'),
(72, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 03:33:13'),
(73, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 03:33:34'),
(74, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 03:34:19'),
(75, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 06:27:51'),
(76, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 06:58:09'),
(77, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 07:07:38'),
(78, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 07:12:04'),
(79, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 12:44:53'),
(80, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 12:45:18'),
(81, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 13:01:38'),
(82, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 13:01:47'),
(83, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 13:39:46'),
(84, 2, 'UPDATE', 'Data user telah diperbarui: Ari', '2025-05-14 13:42:34');
...
CREATE TABLE `users` (
  ...
  `address` text DEFAULT NULL,
  `role` enum('admin','user','merchant','supplier','chairman','secretary','treasurer','coordinator','staff','hr') NOT NULL,
  `admin_type` enum('super','sdm','business','tech') NOT NULL,
...
INSERT INTO `users` (`user_id`, `name`, `username`, `gender`, `date_of_birth`, `email`, `password`, `phone`, `profile_picture`, `address`, `role`, `admin_type`, `status`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`, `is_verified`, `otp_code`, `otp_expiry`, `method`) VALUES
(1, 'Ari Eka Prianda', 'Kagerou07', 'male', '2004-03-10', NULL, '$2b$10$T5EXRVOl3v8wGGLFIAipgO0MHYLXYCZA2Tmjz0dOJ1Xm6TGXab6rC', '+6287775793725', '', 'jl.neglasari II', 'user', 'super', 'inactive', NULL, NULL, '2025-05-14 03:10:55', '2025-05-14 03:30:18', 1, NULL, NULL, NULL),
(2, 'Ari', 'Kagerou', 'male', '2004-03-10', 'ariekaprianda399@gmail.com', '$2b$10$cWQhLAeko3bw/SR4kLrP8e17p6gKiJPDK7ld7gl9kOD9KukzK6bvy', NULL, '', 'jl.neglasari II', 'admin', 'super', 'inactive', NULL, NULL, '2025-05-14 03:32:31', '2025-05-14 13:42:34', 1, NULL, NULL, NULL);
