...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2025 at 10:46 AM
...
CREATE TABLE `berita` (
  ...
  `text_berita` text DEFAULT NULL,
  `tanggal_rilis` datetime DEFAULT NULL
...
CREATE TABLE `products` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `stars` enum('1','1.5','2','2.5','3','3.5','4','4.5','5') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(12, 'M Daniel Khaikal', 'danielkhid1', NULL, NULL, 'danielsuleman.dk@gmail.com', 1, '085694098927', '$2y$12$YVEYcuDApc88SX1A3MlL9edcQDtwT8nfrMkZn80ABN11w5gR.kWlm', 'Highway Bogor, Ciluar market, housing menara Kencana no. 12A rt 03/02', NULL, '2003-03-11', 'manager', 'active', NULL, NULL, '2025-05-11 00:21:32', '2025-05-11 01:33:05', 'c4e71c884a47d050d71fdcdebe6c6a5a.png', 'a42213f442a07c2458b0862ed54d65f3.png');
...
(17, 'danielsuleman.dk@gmail.com', '63f15f0665a1de3a5dac413a3a075762', 'email', '2025-05-10 21:42:49', '2025-05-10 21:37:49', '2025-05-10 21:37:49'),
(20, '085694098927', 'f2ccb4e8c996f5ccafaaa711fc6f6535', 'whatsapp', '2025-05-11 00:30:04', '2025-05-11 00:25:04', '2025-05-11 00:25:04');
