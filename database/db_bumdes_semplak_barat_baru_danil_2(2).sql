...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2025 at 09:07 AM
...
CREATE TABLE `products` (
  ...
  `jenis_product` enum('Makanan','Minuman','Pakaian','Properti','Karya Seni','Peternakan') DEFAULT NULL,
  `nama_tempat` varchar(100) DEFAULT NULL,
  `nama_toko` varchar(100) DEFAULT NULL,
  `tier` enum('pro','official') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
